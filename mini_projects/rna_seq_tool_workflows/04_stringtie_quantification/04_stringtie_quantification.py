...
def main() -> None:
    ...
    if not stringtie_binary:
        error_message = "StringTie binary is missing. Install it or place the official binary package under mini_projects/rna_seq_tool_workflows/tools/stringtie_pkg."
    else:
        try:
